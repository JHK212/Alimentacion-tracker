...
- Un solo scenario activo: `rutina` (4 comidas, ~1740 kcal, ~200g prot). Los 4 scenarios viejos quedan en `food-plans` con `legacy:true` — el historial pre-cutover los sigue leyendo. No borrarlos.
